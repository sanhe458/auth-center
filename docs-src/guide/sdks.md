...
| 语言 | 下载 |
|------|------|
| 全语言总包 | [auth-center-sdk-all.zip](https://<AUTH_SERVER>/sdk/auth-center-sdk-all.zip) |
| PHP | [auth-center-sdk-php.zip](https://<AUTH_SERVER>/sdk/auth-center-sdk-php.zip) |
| Python | [auth-center-sdk-python.zip](https://<AUTH_SERVER>/sdk/auth-center-sdk-python.zip) |
| Node.js | [auth-center-sdk-nodejs.zip](https://<AUTH_SERVER>/sdk/auth-center-sdk-nodejs.zip) |
| Java | [auth-center-sdk-java.zip](https://<AUTH_SERVER>/sdk/auth-center-sdk-java.zip) |
| Go | [auth-center-sdk-go.zip](https://<AUTH_SERVER>/sdk/auth-center-sdk-go.zip) |

每个 zip 内包含：SDK 源码 + `examples/` 完整可运行的登录示例。

## 在线浏览

也可以直接在线查看源码：https://<AUTH_SERVER>/sdk/
